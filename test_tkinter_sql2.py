...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        btn_del_dialog = tk.Button(toolbar, text='Удалить', bg='#d7d8e0', bd=0, image=self.delete_img, compound=tk.TOP, command=self.open_delete_dialog)
...
class DB:
    ...
    def delete_date(self, description):
        self.c.execute('''DELETE FROM finance WHERE description='''+description)
...
if __name__ == "__main__":
    ...
    app = Main(root)
    app.pack()
    root.title("Тестовая прога для SQLite")
